...
function About() {
  return (
    <div className='about-container'>
      <h1 className='menitrust'><a href='https://en.wikipedia.org/wiki/Men_I_Trust' target='_blank'>What is Men I Trust?</a></h1>
      <div className='history'>
        ...
        <div className='p1'><p>Men I Trust is a Canadian indie band from Montreal, Quebec. Formed in 2014, the band consists of <b>Emmanuelle Proulx (lead vocals, guitar), Jessy Caron (guitar, bass guitar), and Dragos Chiriac (keyboards).</b>
          ...
          Men I Trust has independently released four studio albums: Men I Trust (2014), Headroom (2015), Oncle Jazz (2019), Forever Live Session (2020) and Untourable Album (2021).
          They have also released many physical-only EPs, Girl (2022), Tailwhip (2018) and other.</p>
        </div>
      </div>
